...
CREATE TABLE booking (id INT NOT NULL AUTO_INCREMENT, places_id INT, users_id INT, check_in TIMESTAMP(), check_out CURRENT_TIMESTAMP, FOREIGN KEY(users_id) REFERENCES users(id), FOREIGN KEY(places_id) REFERENCES places(id) ON DELETE CASCADE, PRIMARY KEY(id));